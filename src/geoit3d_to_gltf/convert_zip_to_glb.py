...
def export_scene_to_glb(
    ...
    # Inseriamo asset.extras (e model_code in scenes[0].extras) nel chunk JSON del GLB
    model_code = asset_extras.get("core_descriptor", {}).get("code")
    patched_glb = _inject_asset_extras_in_glb(glb_bytes, asset_extras, model_code)
